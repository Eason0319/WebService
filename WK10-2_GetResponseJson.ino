...
const char* ssid = "AndroidAP9EED";  // insert your SSID
const char* password = "gbnq6338";  // insert your password
...
void ClientRequest(String value1, String value2, String value3) {
  ...
  const char* event = "test";  //IFTTT事件名稱
  const char* apiKey = "c_cHHQZknBm3FPq3JBUL53";  //IFTTT Applet key
...
char* ClientRequesta() {
  ...
  const char* resource = "/data/2.5/weather?id=1668341&appid=b2ae06dea702f1d3888ec03400d3a24d";
